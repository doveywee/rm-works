...
const CONTACT_CARDS = [
  ...
  { Icon: ShieldCheck, label: "Credentials", value: `${company.dot} · ${company.cal}` },
];
...
export default function SpartanContact() {
  return (
    <>
          ...
          <Reveal delay={0.15}>
            <div className="mt-9 flex flex-wrap justify-center gap-3.5">
              <a
                ...
                className="inline-flex items-center gap-2 bg-[#B68A4E] px-7 py-4 text-[14.5px] font-bold uppercase tracking-[0.06em] text-[#14171C] transition-all hover:bg-[#c79b5e]"
              >
      ...
      {/* ================= CONTACT INFO STRIP ================= */}
      <section className="border-b border-[#14171C]/8 bg-[#FAF8F3]">
        <div className="mx-auto grid max-w-7xl gap-4 px-5 py-10 sm:grid-cols-2 sm:px-8 lg:grid-cols-4">
          {CONTACT_CARDS.map((c, i) => {
            const inner = (
              <div className="flex h-full items-start gap-3.5 border border-[#14171C]/8 bg-white p-5">
                <span className="grid h-10 w-10 shrink-0 place-items-center rounded-md bg-[#14171C] text-[#CDA869]">
                  <c.Icon size={18} />
                </span>
                <span>
                  <span className="block text-[11px] font-bold uppercase tracking-[0.16em] text-[#9E2B24]">
                    {c.label}
                  </span>
                  <span className="mt-1 block text-[14.5px] font-semibold text-[#20242C]">
                    {c.value}
                  </span>
                </span>
              </div>
        ...
        <div className="mx-auto max-w-7xl px-5 py-20 sm:px-8 sm:py-28">
          <div className="grid gap-12 lg:grid-cols-12 lg:gap-16">
            <div className="lg:col-span-5">
                ...
                <div className="mt-8 space-y-3">
                  {[
                    ...
                    <div key={t} className="flex items-center gap-3">
                      <span className="grid h-9 w-9 place-items-center rounded-md bg-[#FAF8F3] text-[#9E2B24] ring-1 ring-[#14171C]/8">
                        <Icon size={17} />
                      </span>
                      <span className="text-[15px] text-[#3a4049]">{t}</span>
                    </div>
                  ))}
                </div>
              </Reveal>
              ...
              <Reveal delay={0.22}>
                <div className="mt-8 border border-[#9E2B24]/20 bg-[#9E2B24]/[0.05] p-6">
                  <p className="text-[15px] font-bold text-[#14171C]">
                    Need faster help?
                  </p>
                  <p className="mt-1.5 text-[14px] text-[#5b616a]">
                    Call {company.name} directly and we&rsquo;ll talk through your
                    move.
                  </p>
                  <a
                    href={company.phoneHref}
                    className="mt-4 inline-flex items-center gap-2 text-[16px] font-bold text-[#9E2B24]"
                  >
      ...
      {/* ================= FAQ ================= */}
      <section className="border-t border-[#14171C]/8 bg-[#F4F1EA]">
        <div className="mx-auto max-w-7xl px-5 py-20 sm:px-8 sm:py-28">
          <FAQ eyebrow="FAQ" title="Moving Questions, Answered" items={FAQS} />

          <Reveal delay={0.1}>
            <div className="mx-auto mt-12 flex max-w-3xl flex-col items-center justify-between gap-5 bg-[#14171C] px-8 py-8 text-center sm:flex-row sm:text-left">
              <div>
              ...
              <a
                href={company.phoneHref}
                className="inline-flex shrink-0 items-center gap-2 bg-[#B68A4E] px-8 py-4 text-[14.5px] font-bold uppercase tracking-[0.06em] text-[#14171C] transition-all hover:bg-[#c79b5e]"
              >
